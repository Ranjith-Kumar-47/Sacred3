...
//import com.example.mandir.BottomNavigationItemView;
import com.pujagoodies.sacred.BottomNavigationItemView;
...
public final class BottomNavigationBar extends ViewGroup {
    ...
    public BottomNavigationBar(Context context, AttributeSet attrs) {
        this(context, attrs, com.pujagoodies.sacred.R.attr.bottom_navigation_bar_style);
    }

    public BottomNavigationBar(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, com.pujagoodies.sacred.R.style.BottomNavigationBar);
    }
    ...
    public BottomNavigationBar(final Context context, AttributeSet attrs, int defStyleAttr,
        ...
        itemHeight = resources.getDimensionPixelSize(com.pujagoodies.sacred.R.dimen.bnb_bottom_navigation_bar_height);
        maxHumpHeight = resources.getDimensionPixelOffset(
                com.pujagoodies.sacred.R.dimen.bnb_bottom_navigation_bar_max_hump_height);
        itemLabelTextColorDefault = createDefaultColorStateList();

        TypedArray a = context.obtainStyledAttributes(attrs, com.pujagoodies.sacred.R.styleable.BottomNavigationBar,
                defStyleAttr, defStyleRes);

        hasActionView = a.hasValue(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_action_layout);
        if (hasActionView) {
            int defaultHumpPadding = resources.getDimensionPixelSize(
                    com.pujagoodies.sacred.R.dimen.bnb_bottom_navigation_bar_action_view_hump_padding);

            actionView = layoutInflater.inflate(
                    a.getResourceId(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_action_layout, 0),
                    actionViewContainer);
            actionView.setClickable(true);
            actionViewAttachMode = a.getInteger(
                    com.pujagoodies.sacred.R.styleable.BottomNavigationBar_action_view_attach_mode, ATTACH_MODE_EMBED);
            actionViewHumpPadding = a.getDimensionPixelSize(
                    com.pujagoodies.sacred.R.styleable.BottomNavigationBar_action_view_hump_padding, defaultHumpPadding);
        }

        itemIconSize = a.getDimensionPixelSize(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_icon_size,
                resources.getDimensionPixelSize(com.pujagoodies.sacred.R.dimen.bnb_bottom_navigation_bar_icon_size));
        if (a.hasValue(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_icon_tint)) {
            itemIconTint = a.getColorStateList(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_icon_tint);
        } else {
            itemIconTint = createDefaultColorStateList();
        }
        if (a.hasValue(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_label_text_appearance_inactive)) {
            itemLabelTextAppearanceInactive = a.getResourceId(
                    com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_label_text_appearance_inactive, 0);
        }
        if (a.hasValue(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_label_text_appearance_active)) {
            itemLabelTextAppearanceActive = a.getResourceId(
                    com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_label_text_appearance_active, 0);
        }
        if (a.hasValue(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_label_text_color)) {
            itemLabelTextColor = a.getColorStateList(
                    com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_label_text_color);
        }
        itemContentSpacing = a.getDimensionPixelSize(
                com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_content_spacing,
                resources.getDimensionPixelSize(
                        com.pujagoodies.sacred.R.dimen.bnb_bottom_navigation_bar_item_content_spacing));

        itemBackgroundRes = a.getResourceId(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_background,
                0);
        if (a.hasValue(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_ripple_color)) {
            itemRippleColor = a.getColorStateList(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_ripple_color);
        }
        itemRippleEnabled = a.getBoolean(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_ripple_enabled,
                true);
        itemUnboundedRipple = a.getBoolean(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_unbounded_ripple,
                true);
        itemLabelVisibilityMode = a.getInteger(
                com.pujagoodies.sacred.R.styleable.BottomNavigationBar_item_label_visibility_mode, LABEL_VISIBILITY_ALWAYS);

        if (a.hasValue(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_elevation)) {
            setElevation(a.getDimensionPixelSize(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_elevation,
                    0));
        }
        ...
        if (a.hasValue(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_navigation_menu)) {
            inflateMenu(a.getResourceId(com.pujagoodies.sacred.R.styleable.BottomNavigationBar_navigation_menu,
                    0));
        }
